...
export async function POST(request: Request) {
  ...
  //           {
  //             type: "text",
  //             text: 'This image should be an image of a pdf online receipt (memo form). I need you to extract the data on the receipt. Do not include any explanations, only provide a valid JSON response following this format without deviation. The store name will be somewhere at the top. It can be in bold, larger font, or it will say from: store name. There will also be a product id or a upc barcode. If the title says UPC, fill it in the barcode field. If it says product id or item id please fill it in the product_id field. I need the price and total amount to be only the number values. For example if the price or total amount you read is USD 294.00 please change it to 294. If the price has a '$' in it, please remove it. Please fill in the data like this: {"receipt":{"store":"","date_purchased":"","total_amount":"","items":[{"description":"","price":"","barcode":"", product_id:""}]}} Please do not start the object with ```json. If this does not look like a receipt, please type: "This is not a receipt."',
  //           },
  //           {
  //             type: "image_url",
  //             image_url: image,
