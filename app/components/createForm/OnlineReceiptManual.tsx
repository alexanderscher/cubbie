  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <input
          className="w-full bg border-[1px] border-emerald-900 p-2 rounded focus:outline-none"
          name="description"
      ...
      <div className="flex gap-4">
        <button
          type="button"
          className="border-[1px] border-emerald-900 w-full p-4 rounded text-emerald-900 "
          onClick={() => {
            setShowScanner(true);
            setIsBarcode(false);
          }}
